...
/// Empty tree root: the precomputed root of a tree with all empty leaves.
///
/// This is the value of `validator_merkle_root` at initial deployment
/// (before any validators are registered). Computed as:
/// empty_nodes[TREE_DEPTH] where empty_nodes is the chain of empty hashes.
///
/// Source: spec-sparse-merkle-tree.md Lines 206-254
pub const EMPTY_TREE_ROOT: [u8; 32] = [
    0x04, 0x50, 0xf5, 0x5c, 0x22, 0x83, 0xbe, 0x5d, 0x95, 0xe2, 0x97, 0x46, 0xa0, 0x9c, 0x0e, 0xff,
    0x22, 0x91, 0x7a, 0xa0, 0x73, 0x36, 0xc1, 0x3c, 0xfc, 0x92, 0x0d, 0x4a, 0x30, 0x16, 0xd6, 0xbd,
];
