...
### Bug Fixes
- **build:** Make build.rs verify the committed puzzle artifacts instead of overwriting them (#11)

## [0.4.0] - 2026-08-21

### Chores
- **deps:** Uplift chia-wallet-sdk 0.18 -> 0.34 (#8)
...
### Bug Fixes
- **chia-l2-consensus:** Add description+license for crates.io publish (#1004) (#5)

## [0.2.1] - 2026-07-18

### CI
- **publish:** Install rue in the crates.io publish job (#1093) (#4)
